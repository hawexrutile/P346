...
'''
This function takes a address of the file as input(if the file is in some other directory 
than the code) or the file name if the file is in the same directory as the code. The elements of the 
matrix in the file should be space seperated
'''
